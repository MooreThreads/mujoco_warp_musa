...
from .mujoco_musa.warp_bridge import solver as solver_musa
...
@musa_module(solver_musa._linesearch_copydata)
@event_scope
...
@musa_module(solver_musa._update_constraint_copydata)
...
@musa_module(solver_musa._update_gradient_copydata)
...
@musa_module(solver_musa.create_context_copydata)
...
@musa_module(solver_musa.solve_copydata)
@event_scope
