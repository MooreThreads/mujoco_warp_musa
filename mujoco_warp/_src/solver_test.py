...
class SolverTest(parameterized.TestCase):
  ...
  def test_solve_batch(self, cone, solver_, iterations, ls_iterations):
    ...
    d.musa_data.qacc_warmstart = axinfra.from_numpy(qacc_warmstart, dtype=axinfra.float32)
    d.musa_data.qM = axinfra.from_numpy(qM, dtype=axinfra.float32)
    d.musa_data.qacc_smooth = axinfra.from_numpy(qacc_smooth, dtype=axinfra.float32)
    d.musa_data.qfrc_smooth = axinfra.from_numpy(qfrc_smooth, dtype=axinfra.float32)
    d.musa_data.efc.J = axinfra.from_numpy(efc_J_fill, dtype=axinfra.float32)
    d.musa_data.efc.D = axinfra.from_numpy(efc_D_fill, dtype=axinfra.float32)
    d.musa_data.efc.aref = axinfra.from_numpy(efc_aref_fill, dtype=axinfra.float32)
    ...
    if solver_ == SolverType.CG:
      ...
      d.musa_data.qLD = axinfra.from_numpy(qLD, dtype=axinfra.float32)
